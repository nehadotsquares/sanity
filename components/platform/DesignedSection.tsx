...
export default function DesignedSection({ data }: DesignedSectionProps) {
	return (
		<section className="py-24">
			<div className="mx-auto max-w-7xl px-6">
				{/* Row 1 - Heading */}
				<h2 className="mb-12 text-4xl lg:text-4xl">{data?.heading}</h2>
				...
				<div className="mx-auto max-w-4xl text-center">
					<p className="text-xl lg:text-xl">{data?.subHeading}</p>
				</div>
			</div>
		</section>
	);
