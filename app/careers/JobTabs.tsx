		...
		<div>
			...
			{activeTab === "application" && (
				<form
					...
					className="space-y-10 border rounded-3xl p-8 bg-[#f4f4f5] border-[#a1a1aa]"
				>
					{/* SECTION HEADER */}
					...
					<div className="space-y-8">
						...
						<div className="space-y-4">
							...
							{errors.authorized && (
								<p className="text-red-500 text-sm">{errors.authorized}</p>
							)}
						</div>
						...
						<div className="space-y-4">
							...
							{errors.sponsorship && (
								<p className="text-red-500 text-sm">{errors.sponsorship}</p>
							)}
						</div>
					</div>
					...
					<div className="space-y-6">
						...
						<div className="space-y-2">
							...
							<p className="text-sm text-gray-500">
								We ask for your LinkedIn or personal website and your
								GitHub/code portfolio to help verify that you’re a real person,
								not to evaluate or rank your work.
							</p>
					...
					<div className="space-y-6">
						<div>
							<h3 className="text-2xl font-semibold">Motivations</h3>

							<p className="text-gray-600 mt-1">
								We use AI every day — it’s fundamental to Company_name! But for
								these next questions, we’re more interested in your voice. Keep
								it short, thoughtful, and human.
							</p>
						</div>
						...
						<div className="space-y-2">
							<label className="font-medium">
								Briefly describe a recent project, problem, or challenge you’re
								proud of - we're particularly interested in any experience you
								have in a fast-paced, start-up environment or working within
								ambiguity.
							</label>
