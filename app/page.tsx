		...
		<div>
			...
			<section className="relative h-[500px] flex items-center justify-center text-white">
				...
				<div className="relative z-10 text-center px-6">
					<h1 className="text-6xl font-bold mb-6">{home?.heroTitle}</h1>

					<p className="text-xl max-w-2xl mx-auto mb-8">{home?.heroSubtitle}</p>
			...
			<section className="bg-black text-white py-20">
				<div className="max-w-7xl mx-auto px-6">
					<h2 className="text-center text-3xl mb-12">{home?.trustedText}</h2>
			...
			{/*Attacker section*/}
			<section
				className="relative py-15 overflow-hidden bg-cover bg-no-repeat bg-center"
				style={{
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
						{home?.differentiationCards?.map((card: any) => (
							...
							>
								<h3 className="text-2xl mb-4 text-white">{card.title}</h3>
					...
					<div className="grid lg:grid-cols-2 gap-20">
						...
						<div className="space-y-10">
							{home?.processCards?.map((card: any, index: number) => (
								<div key={card._key} className="sticky top-20">
									{/* Content */}
									<div className="grid md:grid-cols-2 gap-6 items-center border border-gray-300 bg-white rounded-xl p-6 hover:border-[#bbcfea] hover:shadow-[20px_0_50px_10px_#bbcfea80]">
										<div>
											<span className="text-1xl">{card.number}</span>

											<h3 className="text-2xl mt-3 mb-3">{card.title}</h3>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<div>
							...
							<div>
								...
								<p className="">{home?.testimonialPersonRole}</p>
							</div>
						</div>
